/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+basic+batch+c+csharp+cpp+cmake+css-extras+d+dart+diff+docker+dot+git+linker-script+go+go-module+gradle+groovy+haskell+http+ini+java+javadoc+javadoclike+jsdoc+js-extras+json+json5+kotlin+latex+lisp+lua+makefile+markdown+markup-templating+mermaid+mongodb+nasm+nginx+nsis+objectivec+perl+php+phpdoc+php-extras+powershell+python+r+regex+scala+scheme+shell-session+sql+swift+systemd+tcl+typescript+vala+vbnet+vim+visual-basic+wasm+yaml&plugins=line-numbers+show-language+inline-color+toolbar+copy-to-clipboard */
